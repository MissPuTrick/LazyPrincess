...
BOT_TOKEN = environ.get('BOT_TOKEN', '6161117913:AAFK8kPG2vvD0fU9ZiyGsmv1qzqZWXVcJIs')
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001671452210'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'TMID_CSbot')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b><i>TelMovID » {file_name}</i></b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("🏷 𝖳𝗂𝗍𝗅𝖾: <a href={url}>{title}</a> \n🔮 𝖸𝖾𝖺𝗋: {year} \n⭐️ 𝖱𝖺𝗍𝗂𝗇𝗀𝗌: {rating}/ 10 \n🎭 𝖦𝖾𝗇𝖾𝗋𝗌: {genres} \n\n🎊 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 [TelMovID](https://t.me/TelMovID21)")
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL','-1001854438553'))

#ai
AI = is_enabled((environ.get("AI","True")), False)
OPENAI_API = environ.get("OPENAI_API","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")
